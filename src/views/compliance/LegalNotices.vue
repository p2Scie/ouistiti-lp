<template>
  <section class="legal-notices">
    <div class="wrapper">
      <h1 class="title">Mentions légales <span class="dot"> •</span></h1>
      <h1 class="title-desktop">
        <span class="dot">• </span>Mentions légales <span class="dot"> •</span>
      </h1>
      <ul>
        <li>
          <h4>1. Présentation du site <span class="dot"> •</span></h4>
          <p>
            ...
            <a href="https://ce-space.fr">https://ce-space.fr</a> l'identité des
            différents intervenants dans le cadre de sa réalisation et de son
            suivi :
          </p>
          <p>
            <strong>Propriétaire</strong> : Cé'Space - 75011 <br />
            <strong>Créateur</strong> :
            <a href="https://ce-space.fr">Ouistiti Agency</a><br />
            <strong>Responsable publication</strong> : Ouistiti Agency –
            oustiticompetitionb3@gmail.com<br />
            Le responsable publication est une personne physique ou une personne
            morale.<br />
            <strong>Webmaster</strong> : Stevens Demervil –
            sdemervil@gmail.com<br />
            <strong>Hébergeur</strong> : Site Déployé sur
            <a href="https://www.netlify.com/" target="_blank">Netlify</a><br />
          </p>
        </li>
        <li>
          <h4>
            2. Conditions générales d’utilisation du site et des services
            proposés<span class="dot"> •</span>
          </h4>
          <p>
            L’utilisation du site
            <a href="https://ce-space.fr">https://ce-space.fr</a> implique
            ...
            utilisateurs du site
            <a href="https://ce-space.fr">https://ce-space.fr</a> sont donc
          ...
          <p>
            ...
            toutefois décidée par Ouistiti Agency, qui s’efforcera alors de
            communiquer préalablement aux utilisateurs les dates et heures de
            l’intervention.
          </p>
          <p>
            Le site <a href="https://ce-space.fr">https://ce-space.fr</a> est
            mis à jour régulièrement par Ouistiti Agency. De la même façon, les
        ...
        <li>
          <h4>
            3. Description des services fournis<span class="dot"> •</span>
          </h4>
          <p>
            Le site <a href="https://ce-space.fr">https://ce-space.fr</a> a pour
            objet de fournir une information concernant l’ensemble des activités
            de la société.
          </p>
          <p>
            Ouistiti Agency s’efforce de fournir sur le site
            <a href="https://ce-space.fr">https://ce-space.fr</a> des
          ...
          <p>
            ...
            <a href="https://ce-space.fr">https://ce-space.fr</a> sont données à
            titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
            renseignements figurant sur le site
            <a href="https://ce-space.fr">https://ce-space.fr</a> ne sont pas
        ...
        <li>
          <h4>
            5. Propriété intellectuelle et contrefaçons<span class="dot">
              •</span
            >
          </h4>
          <p>
            Ouistiti Agency est propriétaire des droits de propriété
        ...
        <li>
          <h4>6. Limitations de responsabilité<span class="dot"> •</span></h4>
          <p>
            Ouistiti Agency ne pourra être tenue responsable des dommages
            directs et indirects causés au matériel de l’utilisateur, lors de
            l’accès au site https://ce-space.fr, et résultant soit de
          ...
          <p>
            Ouistiti Agency ne pourra également être tenue responsable des
            dommages indirects (tels par exemple qu’une perte de marché ou perte
            d’une chance) consécutifs à l’utilisation du site
            <a href="https://ce-space.fr">https://ce-space.fr</a>.
          </p>
          <p>
            Des espaces interactifs (possibilité de poser des questions dans
            l’espace contact) sont à la disposition des utilisateurs. Ouistiti
            Agency se réserve le droit de supprimer, sans mise en demeure
            ...
            relatives à la protection des données. Le cas échéant, Ouistiti
            Agency se réserve également la possibilité de mettre en cause la
        ...
        <li>
          <h4>
            7. Gestion des données personnelles<span class="dot"> •</span>
          </h4>
          <p>
          ...
          <p>
            ...
            <a href="https://ce-space.fr">https://ce-space.fr</a> l’obligation
          ...
          <p>
            ...
            <a href="https://ce-space.fr">https://ce-space.fr</a> n'est publiée
            ...
            Ouistiti Agency et de ses droits permettrait la transmission des
        ...
        <li>
          <h4>8. Liens hypertextes et cookies<span class="dot"> •</span></h4>
          <p>
            Le site
            <a href="https://ce-space.fr">https://ce-space.fr</a> contient un
            certain nombre de liens hypertextes vers d’autres sites, mis en
            place avec l’autorisation de Ouistiti Agency. Cependant, Ouistiti
            Agency n’a pas la possibilité de vérifier le contenu des sites ainsi
            visités, et n’assumera en conséquence aucune responsabilité de ce
            fait.
          </p>
          <p>
            La navigation sur le site
            <a href="https://ce-space.fr">https://ce-space.fr</a> est
        ...
        <li>
          <h4>
            9. Droit applicable et attribution de juridiction<span class="dot">
              •</span
            >
          </h4>
          <p>
            Tout litige en relation avec l’utilisation du site
            <a href="https://ce-space.fr">https://ce-space.fr</a> est soumis au
        ...
        <li>
          <h4>
            10. Les principales lois concernées<span class="dot"> •</span>
          </h4>
          <p>
        ...
        <li>
          <h4>11. Lexique<span class="dot"> •</span></h4>
          <p>
